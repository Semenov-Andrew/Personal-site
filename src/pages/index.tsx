...
export default function Home() {
  const hello = api.example.hello.useQuery({ text: "form tRPC" });
  const user = useUser();
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#3a1493] to-[#6710c6]">
